...
<div class="container-fluid" id="container-wrapper">
                                ...
                                <form id="frmAddVaksinasi" action="{{ url('addVaksinasi') }}" method="POST" role="form">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_vaksinasi"
                                                placeholder="Masukan Nama Vaksinasi">
                                        </div>
                                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{url('deleteVaksinasi', $data->id_vaksinasi)}}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('delete')
    ...
    {{-- Modal Edit --}}
    @foreach ($datas as $data)
    <div class="modal fade" id="edit-data-{{$data->id_vaksinasi}}" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
