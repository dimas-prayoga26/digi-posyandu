      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="alerts.html">Bidan</a>
            <a class="collapse-item" href="buttons.html">Kader</a>
            <a class="collapse-item" href="dropdowns.html">Admin Puskesmas</a>
          </div>
        </div>
      </li>
      <!--<li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="simple-tables.html">Kategori</a>
            <a class="collapse-item" href="datatables.html">Imunisasi</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
