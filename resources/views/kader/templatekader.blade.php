...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('kader/dashboard')}}">
        <div class="sidebar-brand-icon">
        <!--<img src="img/logo/logo2.png">-->
        <i class="fa fa-id-card fa-3x" aria-hidden="true"></i>
        </div>
        <div class="sidebar-brand-text mx-3">Dashboard Kader</div>
      </a>
      <hr class="sidebar-divider my-0">
      <li class="nav-item active">
        <a class="nav-link" href="{{url('kader/dashboard')}}">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-white small">Kader</span>
              </a>
